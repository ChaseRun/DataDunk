...
def getTable(table):
	...
	cluster = MongoClient("mongodb+srv://chase:1z4tEE0ToyngfLov@cluster0-rrnjh.mongodb.net/test?retryWrites=true&w=majority&connectTimeoutMS=480000&serverSelectionTimeoutMS=480000")
