...
def getTable(table):
	...
	cluster = MongoClient("mongodb+srv://chase:thatredguy7@cluster0-rrnjh.mongodb.net/test?retryWrites=true&w=majority&connectTimeoutMS=480000&serverSelectionTimeoutMS=480000")
